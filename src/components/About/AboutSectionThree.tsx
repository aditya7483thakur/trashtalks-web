        ...
        <div className="flex flex-wrap justify-center gap-8">
          ...
          >
            <div className="rounded-lg bg-white p-8 shadow-two duration-300 hover:shadow-one dark:bg-dark dark:shadow-three dark:hover:shadow-gray-dark">
              ...
              <p className="mb-6 border-b border-body-color border-opacity-10 pb-6 text-center text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white sm:text-lg">
                ...
                &quot;Uncle&quot; to trigger a barrage of comedic and
                exaggerated responses inspired by the &ldquo;Emotional
                Damage&rdquo; meme. Enjoy a fun and entertaining twist with each
                interaction!
              </p>
            </div>
          </div>
          ...
          >
            <div className="rounded-lg bg-white p-8 shadow-two duration-300 hover:shadow-one dark:bg-dark dark:shadow-three dark:hover:shadow-gray-dark">
              ...
              />
              <p className="mb-6 border-b border-body-color border-opacity-10 pb-6  text-center text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-10 dark:text-white sm:text-lg">
                Type &quot;Chef&quot; to summon Gordon Ramsay and receive
                comically scathing remarks and hilarious critiques. Get ready
                for a virtual kitchen roast with the fiery chef&apos;s iconic
                insults. It&apos;s a fun, dysfunctional twist on culinary banter
