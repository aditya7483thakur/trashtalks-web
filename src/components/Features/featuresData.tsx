...
const featuresData: Feature[] = [
  {
    ...
    title: "Hackathon with Lewis",
    paragraph:
      "Crafted specifically for the Hackathon with Lewis, our app brings a unique blend of wit and functionality, ensuring your experience is as entertaining as it is groundbreaking.",
  },
  {
    id: 2,
    icon: (
    ...
    title: "Stunning Aesthetic Design",
    paragraph:
      "Built with React Native, our app boasts a sleek and modern UI/UX that not only looks great but also offers a seamless and engaging user experience.",
  },
  {
    id: 3,
    icon: (
    ...
    title: "Smart Roasting with AI Integration",
    paragraph:
      "Leveraging advanced ML techniques like Langchain and prompt templating, our bots are integrated with a Flask RESTful API to deliver personalized and clever responses that are always on point.",
  },
];
